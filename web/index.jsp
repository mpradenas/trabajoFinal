							...
							<div class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" role="widget">
								...
								<div role="content">
									...
									<div class="widget-body no-padding">
										...
										<form class="smart-form" action="controlador?action=guardar" method="post">
											<header>
												Estudiante
											</header>
												...
												<div class="row">
													...
													<section class="col col-2">
														<label class="label">
                                                                                                                ...
                                                                                                                <label class="input">
															<input type="text" id="fecha" class="datepicker" name="fecha"placeholder="dd/mm/yyyy" required>
														</label>
													</section>
